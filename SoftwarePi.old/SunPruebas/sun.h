...
sun_t* sun_new (sun_date_t date, sun_time_t time, int prio, int ceil);
void sun_init (sun_t* this, sun_date_t date, sun_time_t time, int prio, int ceil);
void sun_set_time (sun_t* this, sun_date_t date, sun_time_t time);
