...
sun_t*
sun_new (sun_date_t date, int prio, int ceil)
{
	sun_t* this = (sun_t*) malloc (sizeof (sun_t));
	sun_init (this, date, prio, ceil);
	return this;
}

void
sun_init (sun_t* this, sun_date_t date, int prio, int ceil)
{
	this->sunrise = NULL;
	this->sunset = NULL; 
	sun_set_time (this, date);
...
void
sun_set_time (sun_t* this, sun_date_t date)
{
