...
train_t* train_new (char* name, char ID, char n_wagon, char length, dcc_sender_t* dcc, telemetry_t telemetry);
void train_init (train_t* this, char* name, char n_wagon, char length,dcc_sender_t* dcc, telemetry_t telemetry);
void train_destroy (train_t* this);
void train_cmd (char* arg);
